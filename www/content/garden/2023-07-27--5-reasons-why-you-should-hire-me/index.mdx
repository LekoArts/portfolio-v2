...
From 2019 to 2023 I maintained [Gatsby](https://github.com/gatsbyjs/gatsby), one of the major React meta frameworks. As a team we shipped multiple major versions featuring a lot of awesome features, more recently things like Partial Hydration (powered by React Server Components) or ESM support. While I used a lot of other awesome open source software (e.g. webpack, Babel, LMDB, Redux) I also built such widely used software myself.

Thus I have a deep understanding of React, GraphQL, build tooling, API design and maintenance, publishing packages, and more things than I can count. Generally speaking I have the “under the hood”-knowledge that makes a React meta framework work.
...
My background allows me to approach technical writing and mentoring junior folks with empathy and joy. I care about creating educational content, lifting everyone up with me, and open source since I’ve directly benefited from all these things myself.
