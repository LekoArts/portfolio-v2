...
Recently I was stuck on a TypeScript problem involving enums and how to turn those into a string literal type. I was working on public TypeScript types for a project which internally used enums. And normally I prefer using enums over string literal types, but in this instance I wanted the users to not have to import the enums everytime. They should get intellisense automatically. And that's where string literal types are better than enums.
