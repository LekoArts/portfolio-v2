...
The following instructions require you to use at least `gatsby@^4.0.0`, `gatsby-plugin-mdx@^4.0.0`, and `@mdx-js/react@^2.0.0`.
...
The instructions were adapted from the MDX Guide [Syntax Highlighting witht the `meta` field](https://mdxjs.com/guides/syntax-highlighting/#syntax-highlighting-with-the-meta-field).
