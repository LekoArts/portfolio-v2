...
export default function Home({ data }) {
  return (
    <main>
      ...
      <p>
        {data.info.description}: <br /> <a href={data.info.link}>Visit the website</a> or scan this QR code:
      </p>
      <img alt="QR Code to the authors homepage" src={data.info.qrCodeDataURL} />
    </main>
  )
}
