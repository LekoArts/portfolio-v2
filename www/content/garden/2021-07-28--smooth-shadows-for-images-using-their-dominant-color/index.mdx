...
```css
box-shadow: 0 2.8px 2.2px rgba(0, 0, 0, 0.042), 0 6.7px 5.3px rgba(0, 0, 0, 0.061), 0 12.5px 10px rgba(0, 0, 0, 0.075), 0
    22.3px 17.9px rgba(0, 0, 0, 0.089), 0 41.8px 33.4px rgba(0, 0, 0, 0.108), 0 100px 80px rgba(0, 0, 0, 0.15);
```
...
As always, MDN as a good explanation on [box-shadow](https://developer.mozilla.org/en-US/docs/Web/CSS/box-shadow). The generated CSS from "Smooth Shadow" is in this syntax:
