...
![Figma project showing screenshots of inspirational websites for creating the hero section. They are all quite colorful and have abstract "blob" shapes in them. Light color palette. The last screenshot shows the website of Refactoring UI.](./figma-inspiration-websites.jpg)
