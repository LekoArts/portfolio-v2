...
```js title=plugins/gatsby-source-plausible/gatsby-node.js {10-15}
const fetch = require("node-fetch")
const POST_NODE_TYPE = `PlausibleTopPage`
...
```js title=plugins/gatsby-source-plausible/gatsby-node.js {17-30}
const fetch = require("node-fetch")
const POST_NODE_TYPE = `PlausibleTopPage`
