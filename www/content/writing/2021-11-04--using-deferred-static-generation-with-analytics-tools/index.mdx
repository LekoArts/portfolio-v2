...
1. For now you can leave the sections about integrations and environment variables empty
...
Go to some pages that you now should be marked as deferred. The first request might take a bit longer, after that the requests to other DSG pages should be fast.
