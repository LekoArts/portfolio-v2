...
You need to make sure to use `module.exports` syntax as no other content than the config is allowed in the file.
Otherwise the Figma plugin has problems parsing your config.
...
![After uploading the theme file you then can activate/deactivate "colors" and "typography" and then press "Add styles" to close the dialog.](./theme-ui_step-02.jpg)
