...
Most tips on Twitter are code examples embedded in an image. For a blog post it wouldn't make much sense to display
images instead of copy-able code -- therefore the tweets are not embedded here, but the authors are quoted
differently. If you are the author of one of these tweets and disagree, please contact me. Thanks a lot!
...
Do you have any tips that I should add to this list? Let me know on Twitter at [@lekoarts_de](https://twitter.com/lekoarts_de) and I'll add them!
