...
I'm a designer turned software engineer from Darmstadt, Germany. I currently work at [Netlify](https://www.netlify.com) in the ecosystem team.
...
I work at [Netlify](https://www.netlify.com) in the ecosystem team. Our job is to make every framework seamlessly work on Netlify. Through Netlify's acquisition of Gatsby we're also maintaining the [Gatsby](https://github.com/gatsbyjs/gatsby) framework (My job at Gatsby was to maintain the Gatsby open source framework). Together with my colleagues I implement bug fixes, performance improvements, new features, and review issues & PRs to help >300k users build websites.
