...
The website lives inside the [www](https://github.com/LekoArts/gatsby-themes/tree/main/www) folder of the monorepo and thus is already setup to be used with TypeScript. You can have a look at the source code to see how it's done (as going through the complete code would be a bit boring...). A follow-up blogpost will explain how I created the 3D element in the hero section.
...
Did you build something cool with Theme UI yourself? Share it with me on Twitter at [@lekoarts_de](https://twitter.com/lekoarts_de) as I'm curious what y'all are building!
