...
description: "Learn how to receive build notifications (e.g. from Netlify or Gatsby Cloud) to Discord through webhooks. Most guides only show Slack but now you know how to also use Discord."
date: 2018-10-27
